...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "   GetUserInfo(i64 callTime, string name,  paramMap)")
	fmt.Fprintln(os.Stderr, "  void Put(Article newArticle)")
	fmt.Fprintln(os.Stderr, "  void Process(Article newArticle)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	case "CallBack":
		...
		err23 := containerStruct2.ReadField3(jsProt22)
		if err23 != nil {
			Usage()
			return
		}
	...
	case "GetUserInfo":
		if flag.NArg()-1 != 3 {
			fmt.Fprintln(os.Stderr, "GetUserInfo requires 3 args")
			flag.Usage()
		}
		...
		containerStruct2 := demo.NewBatuThriftGetUserInfoArgs()
		err31 := containerStruct2.ReadField3(jsProt30)
		if err31 != nil {
			Usage()
			return
		}
		argvalue2 := containerStruct2.ParamMap
		value2 := argvalue2
		fmt.Print(client.GetUserInfo(value0, value1, value2))
		fmt.Print("\n")
		break
	case "Put":
		if flag.NArg()-1 != 1 {
	...
	case "Process":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "Process requires 1 args")
			flag.Usage()
		}
		arg38 := flag.Arg(1)
		...
		value0 := argvalue0
		fmt.Print(client.Process(value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
